...
ZR_GPIO(GPIO_INT_EDGE_TO_ACTIVE);
ZR_GPIO(GPIO_INT_EDGE_TO_INACTIVE);
 ...
 */
#define ZR_SENSOR(name) \
const uint32_t ZR_ ## name = name

ZR_SENSOR(SENSOR_TRIG_DATA_READY);
ZR_SENSOR(SENSOR_TRIG_DELTA);
ZR_SENSOR(SENSOR_TRIG_NEAR_FAR);
ZR_SENSOR(SENSOR_TRIG_THRESHOLD);
ZR_SENSOR(SENSOR_TRIG_TAP);
ZR_SENSOR(SENSOR_TRIG_DOUBLE_TAP);
ZR_SENSOR(SENSOR_TRIG_FREEFALL);
ZR_SENSOR(SENSOR_TRIG_MOTION);
ZR_SENSOR(SENSOR_TRIG_STATIONARY);
